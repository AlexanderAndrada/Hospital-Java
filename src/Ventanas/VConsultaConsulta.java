...
public class VConsultaConsulta extends javax.swing.JFrame {

    Consultas c= new Consultas();
    public VConsultaConsulta() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Datos de las citas");
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/begin.jpg"))); // NOI18N
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 730, 600));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VConsultaConsulta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
